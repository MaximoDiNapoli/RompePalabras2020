...
public class Games2 {
	...
	private int ultimoIDGames() {
		return BaseDeDatos.ConexionMongoAtlas2.ultimoIDGames();
	}


	public Games2(int game_id, int winner, int player1_id, int player2_id, int puntajePlayer1, int puntajePlayer2) {
